/*Feb 6, 2017 Code Updates
Ray Piccolotti - Adobe

Changes:
Added s.trackSchoolCheck

Edits to work with reagent SPA, Andrew Jones
*/
...
pdomains[4] = "upload.salliemae.com";
pdomains[5] = "authinterview.salliemae.com";
pdomains[6] = "mediaserver.salliemae.com";
pdomains[7] = "activitycenter.salliemae.com";
pdomains[8] = "apply.salliemae.com";
pdomains[9] = "opennetwld.salliemae.com";
pdomains[10] = "opennet.salliemae.com";
pdomains[11] = "login.salliemae.com";
...
if (s.Util.getQueryParam("dest") == "plan" && !isDev) {
    s.account = "salliemaeplanforcollege,salliemaeglobal";
}

//Plan for college uses a different production report suite
if (location.host.indexOf("www.planforcollege.com") != -1) {
    s.account = "salliemaeplanforcollege,salliemaeglobal";
}
...
//     for (var i = 0; i < $("[data-track-link]").length; i++) {
//         $("[data-track-link]")[i].addEventListener("click", function () {
//             try {
//                 var text = this.getAttribute("data-track-link");
//                 if (!text)
//                     text = this.innerHTML;
//                 s.prop4 = text;
...
//     }
//
//     for (var i = 0; i < $("a[id*='xsell_").length; i++) {
//         $("a[id*='xsell_'")[i].addEventListener("click", function () {
//             var dtd = this.id;
//             dtd = dtd.split('xsell_')[1];
//             s.linkTrackVars = "events,list3,eVar46,eVar74";
//             s.events = s.linkTrackEvents = "event58";
//             s.list3 = dtd; //7-27-2015 change
...
/*
Track the school check feature.
result: answer to the question 'Can I get this loan for my school?' eg "yes","no","maybe"
school: the school searched
location: the page the check was done one eg "undergrad"
*/
s.trackSchoolCheck = function(result,school,location){
  location = location || s.pageName || "unkown";
  result = result || "unkown";
  school = school || "unknown";
  s.eVar76 = result + "|" + school;
  s.prop4 = "SM-SchoolCheck-" + location + "-" + result;
  s.linkTrackVars = "eVar76,prop4,events";
  s.events = s.linkTrackEvents = "event70";
  s.tl(this,"o", s.prop4);
}
